                ...
                <div class="col-md-6 ftco-animate bg-blue-acara" style="background-color: #123557; border: 1px solid white;">
                    ...
                    <form class="col-md-12" id="form" onsubmit="return false;" style="margin-top: 30px">
                        ...
                        <div class="col-md-12" style="text-align: center; margin-top: 20px">
                            <input type="submit" onclick="updatePassAction()" class="btn btn-primary px-4 py-2" style="color: white; text-align: center; margin-bottom: 0.3rem !important; font-size: 16px" value="Update Password">
                        </div>
                    </form>
