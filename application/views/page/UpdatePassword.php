        ...
        <div class="container" style="margin-top:100px;">
            <div class="row d-flex align-items-center">
                ...
                <div class="col-md-6 ftco-animate bg-blue-acara" style="background-color: #301b40; border: 1px solid white;border-radius:20px;height:450px;">
                    <div class="col-md-12 center-text" style="margin-bottom: 10px">
                        <img class="col-7 col-sm-4" src="<?php echo base_url('assets/img/logo-bios-2.png'); ?>">
                    </div>

                    <form class="col-md-12" id="form" onsubmit="return false;" style="margin-top: 10px;">
