...
<body>
  ...
  <div style="padding:0px 16px 0px 16px;">
    <form class="col-md-12 container" method="post" action="<?= base_url('AdminLogin/action') ?>">
      <div class="col-md-12">
        <input id="name" class="login-input" type="text" placeholder="Username" name="name" required>
      </div><br>
      <div class="col-md-12">
      ...
      <div class="col-md-12" style="text-align: center; margin-top: 20px">
        <input type="submit" class="btn btn-primary px-4 py-2" style="color: white; text-align: center; margin-bottom: 0.3rem !important; font-size: 16px" value="SIGN IN">
      </div>
    </form>
  </div>
