...
<body>
    ...
    <div style="padding:0px 16px 0px 16px;">
        <form id="form" class="col-md-12 container" onsubmit="return false;">
            <div class="col-md-12">
                 <label class="col-md-12" style="font-size: 11px; margin-bottom: 0px; text-align: left; padding-left: 0px"><strong>Rulebook</strong></label><br>
                <a href="<?php echo base_url().'assets/resources/upload/'.$upload['rulebook']; ?>"><?php echo $upload['rulebook'];?></a>
                <input class="col-md-12" type="file" name="rulebook[]">
            </div><br>
            <div class="col-md-12">
                 <label class="col-md-12" style="font-size: 11px; margin-bottom: 0px; text-align: left; padding-left: 0px"><strong>Format Proposal</strong></label><br>
                <a href="<?php echo base_url().'assets/resources/upload/'.$upload['proposal']; ?>"><?php echo $upload['proposal'];?></a>
                <input class="col-md-12" type="file" name="proposal[]">
            </div>
            
            <div class="col-md-12" style="text-align: center; margin-top: 20px">
            <input type="submit" onclick="uploadAction()" class="btn btn-primary px-4 py-2" style="color: white; text-align: center; margin-bottom: 0.3rem !important; font-size: 16px" value="UPLOAD">
            </div>
        </form>
    </div>
...
<script>
    ...
    function uploadAction(){        
        ...
        $.ajax({
            ...
            processData: false,
            contentType: false,
            url: "<?php echo base_url(); ?>Admin/uploadAction",
            data: form_data,
            success: function(ret) {
                if(ret){
                    alert("Success");
                    window.location.assign("<?php echo base_url(); ?>Admin/uploadView");
                }
